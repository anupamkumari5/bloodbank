     ...
     if(isset($_POST['name']) && !empty($_POST['name']))
      {
       if(preg_match('/^[A-Za-z\5]+$/', $_POST['name'])) 
         ...
         <strong>Only lower and upper case and space charecter are allow.</strong>
  	  ...
  	  if(isset($_POST['day']) && !empty($_POST['day']))
      {
       $day = $_POST['day'];
        ...
        <strong>select day Input.</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        </button>
        </div> ';
  	  ...
  	  if(isset($_POST['month']) && !empty($_POST['month']))
      {
       $month = $_POST['month'];
        ...
        <strong>Select Month Input.</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        </button>
        </div> ';
  	  ...
  	  if(isset($_POST['blood_group']) && !empty($_POST['blood_group']))
      {
       $blood_group = $_POST['blood_group'];
        ...
        <strong>Select Year blood group Input.</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        </button>
        </div> ';
      ...
      {
       if(preg_match('/^[A-Za-z\5]+$/', $_POST['city'])) 
     	{
  			$city = $_POST['city'];
  		}
  		else
  	  ...
  	  if(isset($_POST['contact_no']) && !empty($_POST['contact_no']))
      {
       if(preg_match('/\d{11}/', $_POST['contact_no'])) 
  	  ...
  	  if(isset($_POST['password']) && !empty($_POST['password']) && isset($_POST['c_password']) && !empty($_POST['password']) )
  {
       ...
       if(preg_match($pattern , $_POST['email'])) 
     	{
           ...
           $check_email = $_POST['email'];
             ...
             $emailError = ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
              <strong>Sorry this email ia already exists.</strong>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
               <span aria-hidden="true">&times;</span>
              </button>
               </div> ';
	 ...
	 <div class="form-inline">
       <label for="name">Date of Birth</label><br>
        ...
        <select name="city" id="city" class="form-control demo-default" required>
	        ...
	        <option value="Kech" >Kech</option><option value="Kharan" >Kharan</option>
